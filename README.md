...
To use this configuration, create a folder named `.vscode` at the root of your repository. Inside that folder, place a file named `setting.json`. Copy the `setting.json` from this repository into that location.
